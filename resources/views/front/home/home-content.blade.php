...
@section('content')
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="{{ asset('/front/') }}/images/img1.jpg" width="177" height="213" alt="" class="fl" /></div>
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="{{ asset('/front/') }}/images/img2.jpg" width="177" height="213" alt="" class="fl" /></div>
          <div class="post_content">
